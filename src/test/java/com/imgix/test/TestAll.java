...
public class TestAll {
  ...
  public void testHelperBuildNestedPath() {
    URLHelper uh =
        new URLHelper(
            "securejackangers.imgix.net", "http://www.somedomain.com/example/chester.png", "http");
    assertEquals(
  ...
  public void testHelperBuildSignedURLWithHashMapParams() {
    ...
    URLHelper uh =
        new URLHelper(
            "securejackangers.imgix.net", "example/chester.png", "http", "Q61NvXIy", params);
    assertEquals(
  ...
  public void testHelperBuildSignedURLWithHashSetterParams() {
    URLHelper uh =
        new URLHelper("securejackangers.imgix.net", "example/chester.png", "http", "Q61NvXIy");
  ...
  public static class TestInvalidDomain {
    ...
    public static Iterable<Object[]> data() {
      return Arrays.asList(
          new Object[][] {
            {"Slash", "test.imgix.net/"},
            {"Prepend Scheme", "https://test.imgix.net"},
            {"Append Dash", "test.imgix.net-"},
          });
    }
